package com.example.youthsoccermanager.settingsandtutorials;
...
public class SettingsAndTutorials extends AppCompatActivity implements IHelpProvider{
        private final int LL_TITLE_BAR = R.id.title_bar_settings_tutorial;
        private final int MAIN_VIEW_BODY = R.layout.settings_tutorial;
        private final String PAGE_TITLE = "Settings & Tutorial";
