...
public class StatsMyTeam extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_stats_myteam;
    private final int MAIN_VIEW_BODY = R.layout.stats_myteam;
    private final String PAGE_TITLE = "My Team";
