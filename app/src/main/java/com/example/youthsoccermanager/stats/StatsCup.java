...
public class StatsCup extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_stats_cup;
    private final int MAIN_VIEW_BODY = R.layout.stats_cup;
    private final String PAGE_TITLE = "Cup";
