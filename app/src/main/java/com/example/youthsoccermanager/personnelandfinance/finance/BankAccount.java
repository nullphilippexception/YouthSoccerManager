...
public class BankAccount extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_personnel_finance_bank_account;
    private final int MAIN_VIEW_BODY = R.layout.personnel_finance_bank_account;
    private final String PAGE_TITLE = "Bank Account";
