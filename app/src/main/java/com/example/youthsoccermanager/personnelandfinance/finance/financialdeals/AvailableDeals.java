...
public class AvailableDeals extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_personnel_finance_available_deals;
    private final int MAIN_VIEW_BODY = R.layout.personnel_finance_available_deals;
    private final String PAGE_TITLE = "Available Deals";
