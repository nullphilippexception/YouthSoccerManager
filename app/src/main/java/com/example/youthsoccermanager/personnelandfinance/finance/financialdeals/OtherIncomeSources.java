package com.example.youthsoccermanager.personnelandfinance.finance.financialdeals;
...
public class OtherIncomeSources extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_personnel_finance_other_income_sources;
    private final int MAIN_VIEW_BODY = R.layout.personnel_finance_other_income_sources;
    private final String PAGE_TITLE = "Other Income Sources";
