...
public class CurrentDeals extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_personnel_finance_current_deals;
    private final int MAIN_VIEW_BODY = R.layout.personnel_finance_current_deals;
    private final String PAGE_TITLE = "Current Deals";
