...
public class AssignNewPersonnelRole extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_assign_personnel_role;
    private final int MAIN_VIEW_BODY = R.layout.personnel_finance_assign_personnel_role;
    private final String PAGE_TITLE = "Assign Role";
