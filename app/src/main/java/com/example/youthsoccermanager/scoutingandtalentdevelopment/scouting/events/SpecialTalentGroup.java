...
public class SpecialTalentGroup extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_scouting_schedule_event_sdg_view;
    private final int MAIN_VIEW_BODY = R.layout.scouting_schedule_event_sdg_view;
    private final String PAGE_TITLE = "Spec. Dev. Group";
