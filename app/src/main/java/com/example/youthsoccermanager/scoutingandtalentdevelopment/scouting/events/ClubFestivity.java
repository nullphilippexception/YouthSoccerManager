...
public class ClubFestivity extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_scouting_schedule_event_club_festivity;
    private final int MAIN_VIEW_BODY = R.layout.scouting_schedule_event_club_festivity;
    private final String PAGE_TITLE = "Club Festivity";
