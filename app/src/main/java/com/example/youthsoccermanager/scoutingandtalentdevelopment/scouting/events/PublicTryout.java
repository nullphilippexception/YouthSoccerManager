...
public class PublicTryout extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_scouting_schedule_event_public_tryout;
    private final int MAIN_VIEW_BODY = R.layout.scouting_schedule_event_public_tryout;
    private final String PAGE_TITLE = "Public Tryout";
