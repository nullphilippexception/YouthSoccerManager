...
public class SelectionData extends AppCompatActivity implements IHelpProvider {

    private final int LL_TITLE_BAR = R.id.title_bar_scouting_send_scout; // FIX WHEN CREATED
    private final int MAIN_VIEW_BODY = R.layout.scouting; // FIX WHEN CREATED
    private final String PAGE_TITLE = "Select Squad";
