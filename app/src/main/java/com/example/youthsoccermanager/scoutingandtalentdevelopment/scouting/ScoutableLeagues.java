...
public class ScoutableLeagues extends AppCompatActivity implements IHelpProvider {
    private final int LL_TITLE_BAR = R.id.title_bar_scouting_send_scout_games;
    private final int MAIN_VIEW_BODY = R.layout.scouting_send_scout_games;
    private final String PAGE_TITLE = "Leagues";
